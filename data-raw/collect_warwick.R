...
curl::curl_download(
  "https://novascotia.ca/natr/meb/data/exe/dp505v1sgx_Warwick_Mtn_Litho_Geochem.zip",
  "data-raw/dp505v1sgx_Warwick_Mtn_Litho_Geochem.zip"
)
...
unlink("data-raw/dp505v1sgx_Warwick_Mtn_Litho_Geochem.zip")
